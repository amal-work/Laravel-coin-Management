...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card my-4 "> 
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 buy_card_box">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <h6 class="font-weight-bolder mb-0"> Unbeatable Offer: Save {{$discount->discount}}% with No Refund Purchase (Buy NoRef) </h6>
                ...
                <div class="card-body px-0 pb-2">
                    <div class="b-table">
                        <div class="table-wrapper has-mobile-cards">
                            <table id="cardTable" class="table is-fullwidth is-striped is-hoverable is-fullwidth table align-items-center mb-0" cellspacing="0" width="100%">
    ...
    <script>
        ...
        var table = $('#cardTable').DataTable({
            ...
            columns: [
                ...
                {title: "Bin", data: 'bin', name: 'bin', 'data-label':'binclass'},
            ...
            'columnDefs': [
                {
                    ...
                    'createdCell':  function (td, cellData, rowData, row, col) {
                        $(td).attr('class', 'is-image-cell'); 
                    }
                },
                {
                    'targets': 2,
                    'createdCell':  function (td, cellData, rowData, row, col) {
                        $(td).attr('data-label', 'Bin'); 
                    }
                },
                {
                    'targets': 3,
                    'createdCell':  function (td, cellData, rowData, row, col) {
                        $(td).attr('data-label', 'Exp Date'); 
                    }
                },
                {
                    'targets': 4,
