                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-sm-9 col-md-6">
                                <select class="custom-select form-control-border custom-select-sm" name="type" id="type" required>
                                    ...
                                    <option value="3" @if ( "3" == $card->type) selected @endif>AMEX</option>
                                    <option value="5" @if ( "5" == $card->type) selected @endif>Master Card</option>
                                    <option value="4" @if ( "4" == $card->type) selected @endif>Visa Card</option>
                                    <option value="6" @if ( "6" == $card->type) selected @endif>Visa Card</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-sm-9 col-md-6">                                
                                ...
                                <select name="country" id="country" class="form-control select2bs4 " style="font-size:10px !important; width: 100%;"  required>
                                    ...
                                    @foreach ($countries as $country)
                                        <option value="{{$country->country}}" @if ( $country->country == $card->country) selected @endif>{{$country->country}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9 col-md-6">
                                ...
                                <select name="state" id="state" class="form-control select2bs4 " style="font-size:10px !important; width: 100%;" required>
                                    ...
                                    @foreach ($states as $state)
                                        <option value="{{$state->state}}" @if ( $state->state == $card->state) selected @endif>{{$state->state}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
