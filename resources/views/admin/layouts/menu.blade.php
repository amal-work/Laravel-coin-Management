...
<div class="sidebar">
			...
			<nav class="mt-2">
				<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item {{ (request()->is('admin/card*')) ? 'menu-open' : '' }}">
						<a href="#" class="nav-link {{ (request()->is('admin/card*')) ? 'active' : '' }}"> <i class="fas fa-coins"></i>
                        ...
                        {{-- <ul class="nav nav-treeview">
							<li class="nav-item">
								<a href="/admin/card/country_list" class="nav-link {{ (request()->routeIs('admin.country.list')) ? 'active' : '' }}">
									<i class="far fa-circle nav-icon"></i>
									<p>Country List</p>
								</a>
							</li>
						...
						<ul class="nav nav-treeview">
							<li class="nav-item">
								<a href="/admin/card/state_list" class="nav-link {{ (request()->routeIs('admin.state.list')) ? 'active' : '' }}">
									<i class="far fa-circle nav-icon"></i>
									<p>State List</p>
								</a>
							</li>
                    ...
                    <li class="nav-item  {{ (request()->routeIs('admin.setting*')) ? 'menu-open' : '' }}">
						...
						<ul class="nav nav-treeview">
							...
							<li class="nav-item">
								<a href="{{ route('admin.setting.checkkey') }}" class="nav-link {{ (request()->routeIs('admin.setting.checkkey')) ? 'active' : '' }}">
									<i class="far fa-circle nav-icon"></i>
									<p>Checker Key API</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="{{ route('admin.setting.checkprice') }}" class="nav-link {{ (request()->routeIs('admin.setting.checkprice')) ? 'active' : '' }}">
									<i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item  {{ (request()->routeIs('admin.discount*')) ? 'menu-open' : '' }}">
						<a href="{{url('admin/discount')}}" class="nav-link {{ (request()->routeIs('admin.discount*')) ? 'active' : '' }}"> <i class="fas fa-cogs"></i>
							<p> Discount Management</p>
						</a>
					</li>
                    <li class="nav-item  {{ (request()->routeIs('admin.discount*')) ? 'menu-open' : '' }}">
						<a href="{{url('admin/random/number')}}" class="nav-link {{ (request()->routeIs('admin.discount*')) ? 'active' : '' }}"> <i class="fas fa-cogs"></i>
