                                ...
                                <div class="card-body m-3">
                                    <div class="auth-form">
                                       ...
                                       <h4 class="logo-title m-0">OINEX</h4>
                                        ...
                                        <form method="POST" id="registForm" action="{{ route('registernz') }}">
                                            @csrf
                                            ...
                                            {{ session(['register_captcha' => random_int(1000, 9999)]) }}

                                            <p>Captcha Code: <strong
                                                    style="color: transparent;text-shadow: 0 2px 2px #fff;">{{ session('register_captcha') }}</strong>
                                            </p>
