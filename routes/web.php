...
// nz
Route::post('/regitser', [\App\Http\Controllers\User\UtilController::class, 'RegisterNZ'])->name('registernz');
Route::middleware('user')->name('user.')->group(
    function () {
        ...
        //Raltime Info
        Route::get('/realtime_info',                [App\Http\Controllers\User\HomeController::class, 'realtime_info'])->name('realtime_info');
    }
);
Auth::routes();
...
Route::middleware('admin')->prefix('admin')->name('admin.')->group(
    function () {
        ...
        //file upload
        Route::post('card/upload',                  [App\Http\Controllers\Admin\Card\CardController::class, 'upload_file'])->name('card.file');
		...
		//site setting
		Route::get('setting/check-price',           [App\Http\Controllers\Admin\Setting\SettingController::class, 'checkPrice'])->name('setting.checkprice');
        Route::post('setting/check-price',          [App\Http\Controllers\Admin\Setting\SettingController::class, 'saveCheckPrice'])->name('setting.checkprice');
		Route::get('setting/check-key-api',         [App\Http\Controllers\Admin\Setting\SettingController::class, 'checkKeyApi'])->name('setting.checkkey');
