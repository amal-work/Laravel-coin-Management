...
<script src="<?php echo e(asset('admin_assets/js/coin/coin.js')); ?>"></script>
...
<?php $__env->startPush('page_scripts'); ?>
    <script>
        ...
        var table = $('#cardTable').DataTable({
            ...
            // fixedHeader: true,
            ajax: {
                url: "<?php echo e(route('admin.card.list')); ?>",
                data: function ( d ) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\3.Projects\2023_Projects\May Projects\0518-Laravel(Creative Web Designer with LARAVEL knowledge)-USA-asdauwh8\public_html-latest\resources\views/admin/card/list.blade.php ENDPATH**/ ?>