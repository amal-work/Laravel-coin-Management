...
<html lang="kr">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('admin_assets/css/custom_admin.css')); ?>">
        ...
        <script type="text/javascript" src="/admin_assets/js/include.js?<?php echo e(time()); ?>"></script>
        <style>
            body {
    ...
    <body ng-app="myApp" ng-controller="myController" class="hold-transition sidebar-mini layout-fixed" data-panel-auto-height-mode="height" ng-cloak>
        <div class="wrapper">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                            <img 
                                ...
                                <?php else: ?>
                                    src="<?php echo e(asset('user_assets/images/logo.png')); ?>"
                                <?php endif; ?>
                                class="user-image img-circle elevation-2" alt="User Image">
                                <span class="d-none d-md-inline"><?php echo e(Auth::user()->str_id); ?></span>
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-header bg-primary">
                                <img 
                                    ...
                                    alt="User Image">
                                <p>
                                    <?php echo e(Auth::user()->str_id); ?>

                                    <small>Join Date: <?php echo e(Auth::user()->created_at->format('Y-m-d')); ?></small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="#" class="brand-link" style="height:50px;text-align:center;margin:auto; " >
                    <img src="<?php echo e(asset('user_assets/images/logo.png')); ?>" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
                </a>
        ...
        <!-- <script src="<?php echo e(asset('js/jszip/jszip.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/pdfmake/pdfmake.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/pdfmake/vfs_fonts.js')); ?>"></script> -->
...
<?php /**PATH E:\3.Projects\2023_Projects\May Projects\0518-Laravel(Creative Web Designer with LARAVEL knowledge)-USA-asdauwh8\public_html-latest\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>