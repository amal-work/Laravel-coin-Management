									...
									<ul class="list-group">
										<li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
											...
											<div class="d-flex align-items-center text-gradient text-sm font-weight-bold text-success">
												- $ <?php echo e($setting_prices ? array_key_exists('chk_cards', $setting_prices['check_cards']) ? $setting_prices['check_cards']['chk_cards'] : 0 : 0); ?>
										...
										<li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
											...
											<div class="d-flex align-items-center text-danger text-gradient text-sm font-weight-bold">
												- $ <?php echo e($setting_prices ? array_key_exists('chk_cards_dead', $setting_prices['check_cards']) ? $setting_prices['check_cards']['chk_cards_dead'] : 0 : 0); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\3.Projects\2023_Projects\May Projects\0518-Laravel(Creative Web Designer with LARAVEL knowledge)-USA-asdauwh8\public_html-latest\resources\views/user/card/check.blade.php ENDPATH**/ ?>